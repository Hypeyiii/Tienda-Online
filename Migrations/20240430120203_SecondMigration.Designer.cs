...
namespace Tienda_Online.Migrations
{
    ...
    [Migration("20240430120203_SecondMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tienda_Online.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Tienda_Online.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Tienda_Online.Models.Location", b =>
                {
                    b.HasOne("Tienda_Online.Models.ApplicationUser", "User")
                        .WithMany("Location")
                        .HasForeignKey("UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
